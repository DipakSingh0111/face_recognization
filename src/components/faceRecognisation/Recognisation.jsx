    ...
    try {
      ...
      if (error instanceof DOMException) {
        if (
          ...
          errorMessage =
            "The camera is in use by another application. Please close other apps using the camera.";
        }
      }
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen bg-gray-100 p-4">
      <ShowAlert
        ...
        showAlertTimer={showAlertTimer}
        setShowAlertTimer={setShowAlertTimer}
        isClientConnectedServer={isClientConnectedServer}
        moveToHome={moveToHome}
        recognisedComponent={true}
      />
      <div
        className={`w-full max-w-3xl bg-white rounded-lg shadow-md overflow-hidden ${
          showAlertTimer ? "hidden" : null
        }`}
      >
        ...
        <div className="p-4">
          {isPersonDetected &&
            recognisedPerson &&
            recognisedPerson.toLowerCase() !== "unknown" && (
